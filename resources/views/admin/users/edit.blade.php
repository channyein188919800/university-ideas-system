    ...
    <section class="admin-main">
        <div class="staff-topbar">
            <div>
                ...
                @else
                    <h3 class="mb-1"><i class="fas fa-user-edit"></i> Edit User: {{ $user->name }}</h3>
            ...
            <div class="profile-layout">
                ...
                <div class="profile-avatar-card">
                    ...
                    <button type="submit"
                            ...
                            value="1"
                            class="btn btn-outline-danger w-100 mt-2 {{ $user->profile_image_url ? '' : 'disabled' }}"
                            @if(!$user->profile_image_url) disabled @endif>
