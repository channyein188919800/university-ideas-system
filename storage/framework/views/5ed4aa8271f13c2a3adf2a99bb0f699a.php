<?php $__env->startSection('title', 'Add User - University Ideas System'); ?>
...
<section class="user-create-hero">
    <div class="user-create-shell">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="back-link fade-in-up ripple-container">
                ...
                <div class="row">
                    <div class="col-md-6 field-wrap fade-in-up fade-delay-1">
                        ...
                        <input type="text"
                               ...
                               class="glass-input <?php $__errorArgs = ['name'];
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="glass-error"><i class="bi bi-exclamation-circle"></i><?php echo e($message); ?></div>
                        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 field-wrap fade-in-up fade-delay-2">
                        ...
                        <input type="password"
                               id="password"
                               name="password"
                               class="glass-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 field-wrap fade-in-up fade-delay-2">
                        ...
                        <select id="role" name="role" class="glass-select <?php $__errorArgs = ['role'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row">
                    <div class="col-md-6 field-wrap fade-in-up fade-delay-3">
                        ...
                        <select id="department_id" name="department_id" class="glass-select <?php $__errorArgs = ['department_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between align-items-center action-row fade-in-up fade-delay-4">
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-glass-outline ripple-container">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\university-ideas-system\resources\views/admin/users/create.blade.php ENDPATH**/ ?>