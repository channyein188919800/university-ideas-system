...
<section class="create-hero">
    <div style="max-width: 780px; width: 100%; margin: 0 auto;">
        ...
        <a href="<?php echo e(route('ideas.index')); ?>" class="back-link fade-in-up ripple-container">
        ...
        <div class="glass-form-card fade-in-up fade-delay-1">
            ...
            <form method="POST" action="<?php echo e(route('ideas.store')); ?>" enctype="multipart/form-data" id="ideaForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group-glass fade-in-up fade-delay-2">
                    ...
                    <input type="text"
                           class="glass-input <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group-glass fade-in-up fade-delay-4">
                    ...
                    <select class="glass-select <?php $__errorArgs = ['categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group-glass fade-in-up fade-delay-5">
                    ...
                    <div class="file-upload-area" id="fileUploadArea">
                        <input type="file"
                               class="<?php $__errorArgs = ['documents'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex justify-content-between align-items-center btn-actions fade-in-up fade-delay-7">
                    <a href="<?php echo e(route('ideas.index')); ?>" class="btn-glass-cancel ripple-container">
